...
export default function HeaderAuth() {
  ...
  const handleSignOut = () => {
    ...
    router.push("/"); // login page is currently hidden; redirect to home
    setTimeout(() => {
  ...
  // Auth UI hidden until Sign In / Register is activated.
  // To re-enable, remove the early return below and uncomment the JSX.
  return null;

  /* --- Re-enable block below when auth is activated ---
  return (
    <>
      <Link
        href="/login"
