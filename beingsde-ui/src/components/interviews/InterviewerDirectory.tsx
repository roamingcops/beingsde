              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 pt-4 border-t border-zinc-100 dark:border-zinc-800/50 mt-auto">
                {p.calendlyLink && (
                  <a
                    ...
                    className="w-full sm:flex-1 inline-flex items-center justify-center gap-1 text-[10px] uppercase font-bold tracking-wider bg-white dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 px-2 py-1 border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 rounded transition-colors"
                  >
                ...
                <button
                  ...
                  className="w-full sm:flex-1 inline-flex items-center justify-center gap-1 text-[10px] uppercase font-bold tracking-wider bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded transition-colors shadow-sm"
                >
                  Simulate
                </button>
              </div>
